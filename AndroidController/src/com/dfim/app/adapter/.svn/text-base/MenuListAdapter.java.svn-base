...
public class MenuListAdapter extends BaseAdapter {
	...
	public MenuListAdapter(Context context, String[] menuItems, String currentTab, String currentFragment) {
		this.context = context;
		this.menuItems = menuItems;
		this.currentTab = currentTab;

		if ("tab_music".equals(currentTab)) {
			this.selectedItem = currentFragment;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (currentTab.equals("tab_music")) {
			...
			// 当前选中菜单项
			if (selectedItem.equals(menuItems[position])) {
				// 设置菜单条目的背景色
			...
			} else if (menuItems[position].equals("已购音乐")) {
